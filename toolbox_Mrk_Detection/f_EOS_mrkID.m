...
% Date       :   December 2019
% -------------------------------------------------------------------------
% Description:   1 - Get radio opaque mrk position in frontal view:
%                    based on a threshold in a moving window that removes 
%                    everything below r_cut * Max of window
%                2 - Based on the height of the markers identified:
%                    take a band of image of +/- dy around the height, 
%                    process image and get mrk
%                3 - 3D position: Merge the positions of side and front 
%                    view 
%                4 - Check for missing markers: do 1,2,3 by starting with 
%                    the side view to get markers not identified on 
%                    frontal view
% Inputs:       front: front DICOM image from EOS imaging
%               side:  side DICOM image from EOS imaging
%               r_cut: Threshold between 0 and 1 - default 0.8
%               test_fig: option to plot or not additional figure
% Outputs:      mrk:  all markers identified
